    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="panel-title bariol-bold">{!! isset($user->id) ? '<i class="fa fa-pencil"></i> Edit' : '<i class="fa fa-user"></i> Create' !!} user</h3>
                    </div>
                </div>
            </div>
            <div class="panel-body">                
                ...
                <div class="col-md-6 col-xs-12"> 
                    @if( isset($u->groups[0]->name) && ($u->groups[0]->name == "Superadmin" || $u->groups[0]->name == "Admin" ))
