		...
		@endif
		  ...
		  <div class="box">
		    ...
		    <div class="box-header with-border">
		      <h3 class="box-title"> <span style="background:#da273a; color:#fff;padding:5px 20px; border-radius:4px;" > {{ trans('backpack::crud.add_a_new') }} {{ $crud->entity_name }} </span> </h3>
		    </div>
		    <div class="box-body">  
...
<style>
.mce-edit-area .mce-container .mce-panel .mce-stack-layout-item textarea{
	height:300px;
}
</style>
